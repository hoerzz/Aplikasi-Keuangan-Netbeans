...
public class DataJabatan extends javax.swing.JFrame {
    ...
    public DataJabatan() {
        ...
        String[] row = {"Kode","Nama Karyawan","Jabatan","Status","Keterangan Kontrak"};
    ...
    public void tampilDataKeTabel(){
        try {
            ...
            while(res.next()){
                ...
                String jabatan = res.getString("katjabatan");
                String status = res.getString("status");
                String kontrak = res.getString("ketkontrak");
                String data[] = {kode,nama,jabatan,status,kontrak};
    ...
    private void getDataFromTable() throws ParseException{
        ...
        String jabat = (String) tabModel.getValueAt(i, 2);
        String stat = (String) tabModel.getValueAt(i, 3);
        String ktk = (String) tabModel.getValueAt(i, 4);
        
        tfKode.setText(kode);
        n_karyawan.setSelectedItem(nama);
        jabatan.setText(jabat);
        status.setText(stat);
        kontrak.setText(ktk);
    ...
    private void keyType(){
        if (!(jabatan.getText().equals(""))&&!(kontrak.getText().equals(""))) {
    ...
    private void initComponents() {
        ...
        setTitle("CV.Bumi Indah :: Data Jabatan");
        ...
        kontrak.addKeyListener(new java.awt.event.KeyAdapter() {
        ...
        jabatan.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                jabatanPropertyChange(evt);
            }
        });
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        if (!(kontrak.getText().equals(""))&&!(n_karyawan.getSelectedItem().equals(""))) {
            try {
                String sql = "INSERT INTO `jabatan_karyawan`( `nmkaryawan`, `katjabatan`, `status`, `ketkontrak`) VALUES (?, ?, ?, ?);";
                ...
                prestat.setString(2,jabatan.getText());
                prestat.setString(3,status.getText());
                prestat.setString(4,kontrak.getText());
    ...
    private void tbPemasukkanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbPemasukkanMouseClicked
        try {
            ...
            Logger.getLogger(DataJabatan.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        if (!(kontrak.getText().equals(""))&&!( n_karyawan.getSelectedItem().equals(""))) {
            try {
                String sql = "UPDATE jabatan_karyawan SET nmkaryawan = ?,katjabatan = ?, status = ?, ketkontrak = ? WHERE id = "+tfKode.getText();
                PreparedStatement prestat = new Fungsi.Koneksi().konek.prepareStatement(sql);
                prestat.setString(1, n_karyawan.getSelectedItem().toString());
                prestat.setString(2,jabatan.getText());
                prestat.setString(3,status.getText());
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        try {
            if (JOptionPane.showConfirmDialog(null, "Apakah anda ingin menghapus?","warning", 2)== JOptionPane.YES_OPTION) {
                String sql = "DELETE FROM jabatan_karyawan WHERE id ="+tfKode.getText();
                Statement stat = new Fungsi.Koneksi().konek.createStatement();
    ...
    private void kontrakKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_kontrakKeyTyped
        // TODO add your handling code here:
        keyType();
    }//GEN-LAST:event_kontrakKeyTyped
    ...
    private void jabatanPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jabatanPropertyChange
        // TODO add your handling code here:
    }//GEN-LAST:event_jabatanPropertyChange
